...
! function (t) {
    ...
    ! function () {
        ...
        }, this.تسجيلAction = function (t, e, n) {
            (this.actions[t] = this.actions[t] || {})[e] = n
        }, this.تسجيلFilter = function (t, e, n) {
    ...
    }, e.BaseStatic.call(e.ControlDefinition), e.ControlDefinition.prototype = Object.create(e.Base.prototype), e.ControlDefinition.prototype.constructor = e.ControlDefinition, e.controlDefinitions = [], e.controlDefinitions.push(new e.ControlDefinition("multimix", "[data-filter][data-sort]")), e.controlDefinitions.push(new e.ControlDefinition("filter", "[data-filter]")), e.controlDefinitions.push(new e.ControlDefinition("sort", "[data-sort]")), e.controlDefinitions.push(new e.ControlDefinition("toggle", "[data-toggle-1]")), e.Control = function () {
        ...
        init: function (t, n, a) {
            ...
            if (this.callActions("beforeInit", arguments), i.el = t, i.type = n, i.selector = a, i.selector) i.status = "live";
                ...
                case "filter":
                    ...
                    break;
                case "toggle":
                    i.filter = i.el.getAttribute("data-toggle-1");
                    break;
                case "sort":
        ...
        handleClick: function (t) {
            ...
            switch (a.type) {
                ...
                case "multimix":
                    ...
                    break;
                case "toggle":
                    l.filter = a.filter || i.getAttribute("data-toggle-1"), r = "live" === a.status ? n.hasClass(i, a.classNames.active) : "active" === a.status
            }
                ...
                for (i = a.el.querySelectorAll(a.selector), s = 0; r = i[s]; s++) {
                    switch (o = new e.CommandMultimix, a.type) {
                        ...
                        case "multimix":
                            ...
                            break;
                        case "toggle":
                            o.filter = r.getAttribute("data-toggle-1")
                    }
